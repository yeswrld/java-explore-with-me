...
public class PrivateCommentController {
    ...
    public CommentDto updateComment(@RequestBody @Valid UpdCommentDto updCommentDto, @PathVariable @Positive Long userId, @PathVariable @Positive Long commentId, HttpServletRequest request) {
    ...
    public void deleteComment(@PathVariable @Positive Long userId, @PathVariable @Positive Long commentId, HttpServletRequest request) {
